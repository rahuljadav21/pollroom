...
export class Create extends Component {
  ...
  render() {
    ...
    return (
      ...
      <form className="container validate-form" noValidate style={{display:'flex',flexDirection:'column',alignItems:'center'}} action="http://localhost:3000/pollroom/Create" method="post">
