        ...
        <>
            ...
            <div className="poll" key={p._id} >
                ...
                <div className="res">
                    ...
                    <div className="opt">
                        <label id='1'>B</label>
                              <input type="radio" defaultChecked={p.option_2.includes(user._id)} disabled={p.option_1.includes(user._id)||p.option_2.includes(user._id)||p.option_3.includes(user._id)||p.option_4.includes(user._id)} name='ans'value='option_2' id="1"/>
                    ...
                    <div className="opt">
                        <label id='1'>C</label>
                              <input type="radio" defaultChecked={p.option_3.includes(user._id)} disabled={p.option_1.includes(user._id)||p.option_2.includes(user._id)||p.option_3.includes(user._id)||p.option_4.includes(user._id)} name='ans'value='option_3' id="1"/>
                    ...
                    <div className="opt">
                        <label id='1'>D</label>
                              <input type="radio" defaultChecked={p.option_4.includes(user._id)} disabled={p.option_1.includes(user._id)||p.option_2.includes(user._id)||p.option_3.includes(user._id)||p.option_4.includes(user._id)} name='ans'value='option_4' id="1"/>
